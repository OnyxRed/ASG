...
switch (_filter) do
{
	...
	case 0:
	{
		[
			...
			["U_O_FullGhillie_ard",nil,120000],
			["U_O_FullGhillie_lsh",nil,120000],
			["U_O_FullGhillie_sard",nil,120000]
		];
	};
	...
	{
		[
			["V_TacVest_khk",nil,22500],
			["V_BandollierB_cbr",nil,14500],
			["V_HarnessO_brn",nil,17500],
			["V_BandollierB_blk",nil,16000],
			["V_Chestrig_blk",nil,17500],
			["V_PlateCarrier1_rgr",nil,27000],
			["V_PlateCarrierGL_mtp",nil,50000],
			["V_PlateCarrierSpec_mtp",nil,50000],
			["V_PlateCarrierSpec_mtp",nil,50000]
