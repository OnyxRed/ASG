...

{
	...
	["life_inv_roadConeL", life_inv_roadConeL],
  ...
  ["life_inv_wallYellow", life_inv_wallYellow],
  ["life_inv_wallOrange", life_inv_wallOrange],
  ["life_inv_trafficCone", life_inv_trafficCone],
