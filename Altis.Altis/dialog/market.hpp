...
class marketView
{
	...
	class controlsBackground
	{
		...
		{
			idc = 1100;
			text = "<t size='1.2' align='center'>Altis Exchange</t>"; //--- ToDo: Localize;
		...
		{
			idc = 1101;
			text = "<t align='center'>Stock Prices</t>"; //--- ToDo: Localize;
			x = 17 * GUI_GRID_W + GUI_GRID_X;
		...
		{
			idc = 1002;
			text = "Since Start"; //--- ToDo: Localize;
	...
	class controls
	{
		...
		{
			idc = 2400;
			text = "Close Market"; //--- ToDo: Localize;
			x = 5 * GUI_GRID_W + GUI_GRID_X;
