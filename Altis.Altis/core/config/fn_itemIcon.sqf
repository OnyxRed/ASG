...
switch (_var) do
{
	...
	case "life_inv_fishingpoles": {("icons\items\noicon.paa")};
	...
	case "life_inv_tbacon": {("icons\items\canned.paa")};
	...
	case "life_inv_trafficCone": {("icons\items\roadcone.paa")};
	case "life_inv_wallYellow": {("icons\items\cbarrier.paa")};
	case "life_inv_wallOrange": {("icons\items\barrier.paa")};
	...
	case "life_inv_houseAlarm": {("icons\items\defusekit.paa")};
	case "life_inv_crumpet": {("icons\items\crumpet.paa")};
	case "life_inv_tea": {("icons\items\tea.paa")};
	case "life_inv_hobnob": {("icons\items\hobnob.paa")};
	case "life_inv_richtea": {("icons\items\richtea.paa")};
	case "life_inv_fritter": {("icons\items\fritter.paa")};
	case "life_inv_lolly": {("icons\items\lolly.paa")};
	case "life_inv_bourbons": {("icons\items\bourbon.paa")};
	case "life_inv_bacon_sandwich": {("icons\items\bacon.paa")};
	case "life_inv_crisps": {("icons\items\crisps.paa")};
	case "life_inv_fishandchips": {("icons\items\fishandchips.paa")};
};