...
//		["U_C_WorkerCoveralls","Mechanic Coveralls",2500], Removed as this is the prison uniform
	...
	case 3:
	{
		[
			...
			["V_TacVest_blk",nil,7000],
			["V_Chestrig_blk",nil,7500],
			["V_PlateCarrier1_rgr",nil,8000],
