...
if(__GETC__(life_coplevel) < 7) exitWith {hint "You are too low of a rank to use this option!";};
if(__GETC__(life_coplevel) == 12) exitWith {hint "HATO cannot crush vehicles!";};
