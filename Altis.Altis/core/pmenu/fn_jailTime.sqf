...
//5 Minutes
_Btn1 buttonSetAction "[life_pInact_curTarget,5] call life_fnc_arrestAction; closeDialog 0;";

//10 Minutes
_Btn2 buttonSetAction "[life_pInact_curTarget,10] call life_fnc_arrestAction; closeDialog 0;";

//15 Minutes
_Btn3 buttonSetAction "[life_pInact_curTarget,15] call life_fnc_arrestAction; closeDialog 0;";

//20 Minutes
_Btn4 buttonSetAction "[life_pInact_curTarget,20] call life_fnc_arrestAction; closeDialog 0;";
