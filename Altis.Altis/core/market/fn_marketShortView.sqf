...
_text = "<t size='1.5' color='#00FF00'>Altis Exchange</t><br/>";

_didanything = false;


/* Commented out as life_market_shortnames is not defined anywhere and this block won't do anything without it.
{
	...
	{
		_text = format["%1<img size='2' image='icons\market\trendup.paa'/> $%2 <br/>", _text, _globalchange];
	}
	else
	{
		_text = format["%1<img size='2' image='icons\market\trenddown.paa'/> $%2 <br/>", _text, _globalchange];
	};
