...
if ( life_cash < 2000 ) exitWith { systemChat "You need £2000 to send a message !"; }; // Hint if person haves no 6000 dollar
...
[[2,format ["%1 sends this from BBC Altis to all: %2",name player,_message]],"life_fnc_broadcast",true,false] call life_fnc_MP;
