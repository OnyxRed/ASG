...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "journalist": {_var = "license_civ_journalist"};
			case "passport": {_var = "license_civ_passport"};
			case "busdriver": {_var = "license_civ_busdriver"};
			case "Gangbase1": {_var = "license_civ_Gangbase1"};
			case "Gangbase2": {_var = "license_civ_Gangbase2"};
			case "Gangbase3": {_var = "license_civ_Gangbase3"};
			case "Gangbase4": {_var = "license_civ_Gangbase4"};
			case "Gangbase5": {_var = "license_civ_Gangbase5"};
			case "Gangbase6": {_var = "license_civ_Gangbase6"};
			default {_var = ""};
		};
	};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_journalist": {_var = "journalist"};
