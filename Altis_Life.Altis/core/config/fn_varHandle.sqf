...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "roadConeL": {"life_inv_roadConeL"};
			...
			case "wallYellow": {"life_inv_wallYellow"};
			case "wallOrange": {"life_inv_wallOrange"};
			case "trafficCone": {"life_inv_trafficCone"};
			case "houseAlarm": {"life_inv_houseAlarm"};
			case "fishandchips": {"life_inv_fishandchips"};
			case "crumpet": {"life_inv_crumpet"};
			case "tea": {"life_inv_tea"};
			case "hobnob": {"life_inv_hobnob"};
			case "richtea": {"life_inv_richtea"};
			case "fritter": {"life_inv_fritter"};
			case "lolly": {"life_inv_lolly"};
			case "bourbons": {"life_inv_bourbons"};
			case "bacon_sandwich": {"life_inv_bacon_sandwich"};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_roadConeL": {"roadConeL"};
			...
			case "life_inv_wallYellow": {"wallYellow"};
			case "life_inv_wallOrange": {"wallOrange"};
			case "life_inv_trafficCone": {"trafficCone"};
			case "life_inv_crisps": {"crisps"};
			case "life_inv_bacon_sandwich": {"bacon_sandwich"};
			case "life_inv_bourbons": {"bourbons"};
			case "life_inv_lolly": {"lolly"};
			case "life_inv_fritter": {"fritter"};
			case "life_inv_richtea": {"richtea"};
			case "life_inv_hobnob": {"hobnob"};
			case "life_inv_tea": {"tea"};
			case "life_inv_crumpet": {"crumpet"};
			case "life_inv_fishandchips": {"fishandchips"};
		};
	};
};
