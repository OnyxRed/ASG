...
if ({(side _x == west) && (_x getVariable["rank",0] != 12)} count playableUnits < 10) exitWith {hint "There must be at least 10 cops online to continue."};
...
[[getPlayerUID player,profileName,"666v"],"life_fnc_wantedAdd",false,false] spawn life_fnc_MP;
