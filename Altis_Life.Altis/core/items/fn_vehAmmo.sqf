...
if (_success) then
{
	...
	if(_veh == "B_HMG_01_F") then
	{
		...
		if(_veh == "O_G_Offroad_01_armed_F") then
	{
		_unit addMagazineTurret ["100Rnd_127x99_mag_Tracer_Yellow",[0]];
		_unit addMagazineTurret ["100Rnd_127x99_mag_Tracer_Yellow",[0]];
		hint "Your 50. Cal Offroad has been reloaded with two extra magazines";
	};
	if(_veh == "O_MRAP_02_hmg_F") then
	{
		_unit addMagazineTurret ["200Rnd_127x99_mag_Tracer_Green",[0]];
	...
	if((_veh != "B_Boat_Armed_01_minigun_F") && (_veh != "O_G_Offroad_01_armed_F") && (_veh != "O_MRAP_02_hmg_F") && (_veh != "I_MRAP_03_hmg_F") && (_veh != "B_MRAP_01_hmg_F") && (_veh != "B_HMG_01_F")) then
	{
