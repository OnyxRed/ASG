...
if(!(_unit getVariable ["surrender",false]) && !(animationState _unit == "Incapacitated") && !(_unit getVariable ["tazed",false]) && !(_unit getVariable["rubber",false])) exitWith {};
...
titleText[format["You have ziptied %1",_unit getVariable["realname",name _unit]],"PLAIN"];
