...
if(isNull _vehicle OR !(_vehicle isKindOf "Car" OR _vehicle isKindOf "Air" OR _vehicle isKindOf "Ship" OR _vehicle isKindOf "House_F" OR (typeOf _vehicle in["IG_supplyCrate_F","Box_NATO_Grenades_F"]))) exitWith { hint "Not working";}; //Either a null or invalid vehicle type.
