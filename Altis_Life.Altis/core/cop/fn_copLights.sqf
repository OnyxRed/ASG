...
switch (typeOf _vehicle) do {
  ...
  case "B_G_Offroad_01_repair_F": { _attach = [[-0.37, 0.0, 0.56], [0.37, 0.0, 0.56]]; };
  ...
  case "C_Van_01_box_F": { _attach = [[-0.38, 2.22, -0.50], [0.38, 2.22, -0.50]]; };
  case "B_G_Van_01_transport_F": { _attach = [[-0.38, 2.22, -0.50], [0.38, 2.22, -0.50]]; };
  case "I_Truck_02_covered_F": { _attach = [[-0.38, 4, -0.50], [0.38, 4, -0.50]]; };
};
