...
_clothes = switch (life_clothing_store) do
{
	...
	case "gangbase1": {[_selection] call life_fnc_clothing_reb;};
    case "gangbase2": {[_selection] call life_fnc_clothing_reb;};
    case "gangbase3": {[_selection] call life_fnc_clothing_reb;};
    case "gangbase4": {[_selection] call life_fnc_clothing_reb;};
    case "gangbase5": {[_selection] call life_fnc_clothing_reb;};
    case "gangbase6": {[_selection] call life_fnc_clothing_reb;};
};
