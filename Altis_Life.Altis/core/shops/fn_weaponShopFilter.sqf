...
switch (_index) do
{
	case 0:
	{
		_config = switch (_shop) do {
            	case "gangbase1": {["rebel"] call life_fnc_weaponShopCfg;};
                case "gangbase2": {["rebel"] call life_fnc_weaponShopCfg;};
                case "gangbase3": {["rebel"] call life_fnc_weaponShopCfg;};
                case "gangbase4": {["rebel"] call life_fnc_weaponShopCfg;};
                case "gangbase5": {["rebel"] call life_fnc_weaponShopCfg;};
                case "gangbase6": {["rebel"] call life_fnc_weaponShopCfg;};
                default {[_shop] call life_fnc_weaponShopCfg;};
        };
		{
